...
export function artifactContactsObjectKey(environment, productId, version) {
  return `artifacts/${environment}/${productId}/${version}/contacts.json`;
}

export function artifactPackageObjectKey(environment, productId, version) {
  return `artifacts/${environment}/${productId}/${version}/package.pdf`;
}

export function artifactAttachmentFilename(productId) {
  return `resalelane-${productId}.pdf`;
}
